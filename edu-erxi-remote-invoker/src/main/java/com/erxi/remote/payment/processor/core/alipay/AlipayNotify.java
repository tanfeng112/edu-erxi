...
public class AlipayNotify {
     ...
     * @return 验证结果
     */
    public static boolean verify(Map<String, Object> params,PaymentConfig config) {
     ...
     * @return 生成的签名结果
     */
	private static boolean getSignVeryfy(Map<String, Object> Params, String sign,PaymentConfig config) {
    	//过滤空值、sign与sign_type参数
    	Map<String, Object> sParaNew = AlipayCore.paraFilter(Params);
        //获取待签名字符串
    ...
    */
    private static String verifyResponse(String notify_id,PaymentConfig config) {
        //获取远程服务器ATN结果，验证是否是支付宝服务器发来的请求

        String partner = config.getAli_partner();
